        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Gestão de Acomodação</h2>
                        <form method="POST" action="acomodacao/persist" enctype="multipart/form-data">
                            <div class="col s12" id="information">
                                <label for="title">
                                    Titulo
                                    <input type="text" name="title" value="<?= (isset($data)) ? $data->getTitle() : ''; ?>">
                                </label>
                ...
                <div class="col s12" id="images">
                                <div class="input">
                                    ...
                                    <input type="hidden" name="acomodacao" value="<?= (isset($data)) ? $data->getTitle() : ''; ?>" />
                                    <input type="hidden" name="acomodacao_id" value="<?= (isset($data)) ? $data->getId() : ''; ?>" />
                                </div>
                                <div class="start">
                                    <?php if(!empty($image)): ?>
...
function Test() {
    ...
    <div class="col s12" id="images" style="background-color: orange">
                                <div class="input">
                                    ...
                                    <input type="file" name="files[]" class="dropify" multiple="multiple" />
                                    <input type="hidden" name="title" value="<?= (isset($data)) ? $data->getTitle() : ''; ?>" />
                                    <input type="hidden" name="id" value="<?= (isset($data)) ? $data->getId() : ''; ?>" />
                                </div>
                                <div class="start">
                                    <?php if(!empty($image)): ?>
                                        <input type="hidden" name="_method" value="PUT">
