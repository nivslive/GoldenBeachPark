...
<head>
    ...
    <title>Mensagens - ADMIN Golden Beach Hotel</title>
    ...
    ?>
                        <tr>
                            ...
                            <td class="container__button">
                                <form method="POST" action="contact/delete"> <input type="hidden" name="_method"
    ...
    <script>
        ...
        for (let i = 0; i < open.length; i++) {
            open[i].addEventListener("click", function (e) {
                ...
                xhttp.open("GET", URL_BASE + "contact/edit/" + data, true);
                xhttp.send();
        ...
        function create() {
            ...
            xhttp.open("GET", URL_BASE + "contact/create", true);
            xhttp.send();
