...
<head>
    ...
    <title> Criar Sessão Ceará - ADMIN BeachParkHotel</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Criar Sessão Ceará</h2>
                        <form method="POST" action="ceara/persist" enctype="multipart/form-data">
                            <input type="hidden" name="topic" value="ceara">
                ...
                <div class="col s12" id="images">
                                <div class="input">
                                    ...
                                    <input type="hidden" name="title_image" value="<?= (isset($edit)) ? $edit->getTitle() : ''; ?>" />
                                    <input type="hidden" name="id" value="<?= (isset($ceara)) ? $ceara->getId() : ''; ?>" />
                                </div>
                                <div class="start">
                                    <?php if(!empty($image)): ?>
