...
<head>
    ...
    <title>Estrutura - ADMIN Golden Beach Hotel</title>
        ...
        <div class="wrapper">
            ...
            <div id="fade-atualizar">
                ...
                <div class="search container">
                    <h2>Busque todas as sessões para Estrutura</h2>
                    <!--Static Data-->
                    <table>
...
for(let i = 0; i < open.length; i++){
    open[i].addEventListener("click", function(e) {
      ...
      var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"estrutura/edit/"+data, true);
                                xhttp.send();
...
function create() {
    var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"estrutura/create", true);
                                xhttp.send();
