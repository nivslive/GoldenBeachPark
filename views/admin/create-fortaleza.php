...
<head>
    ...
    <title> Criar Sessão Fortaleza - ADMIN BeachParkHotel</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Criar Sessão de Passeios de Fortaleza</h2>
                        <form method="POST" action="fortaleza/persist" enctype="multipart/form-data">
                            <input type="hidden" name="topic" value="fortaleza">
                            <div class="col s12" id="information">
                                <label for="title">
                                    Titulo
                                    <input type="text" name="title" value="<?= (isset($acomodacao)) ? $acomodacao->getTitle() : ''; ?>" required>
                                </label>
