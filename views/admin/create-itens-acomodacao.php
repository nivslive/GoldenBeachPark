...
<head>
    ...
    <title>Criar Acomodação Itens - ADMIN BeachParkHotel</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Criar Item Acomodação</h2>
                        <form method="POST" action="acomodacao/itens/persist" enctype="multipart/form-data">
