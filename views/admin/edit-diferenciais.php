...
<head>
    ...
    <title> Gestão de Diferenciais do Hotel</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Gestão da Sessão de Diferenciais</h2>
                        <form method="POST" action="diferenciais/update" enctype="multipart/form-data">
