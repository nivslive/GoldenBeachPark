...
<head>
    ...
    <title>Emails - ADMIN Golden Beach Hotel</title>
                ...
                <tr>
                        <td><?=$email?></td>
                            ...
                            <td class="container__button">
                                <form method="POST" action="newsletter/delete"> <input type="hidden" name="_method"
...
for(let i = 0; i < open.length; i++){
    open[i].addEventListener("click", function(e) {
      ...
      let xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"newsletter/edit/"+data, true);
                                xhttp.send();
...
function create() {
    var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"newsletter/create", true);
                                xhttp.send();
