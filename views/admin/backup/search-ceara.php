...
<body>
                            ...
                            <div class="cadastro container">
                                <fieldset>
                                    <form method="POST" action="ceara/update" enctype="multipart/form-data">
                                        ...
                                        <div class="col s12" class="form-att">
                                            <?php (isset($edit)) ? var_dump($edit) : "Sem edit";
                                    foreach($edit as $e):
     
                                    $edit_title = $e->getTitle();
                                    $edit_description = $e->getDescription();
                                 ?> <?php   endforeach;?>
                                            <label for="title">
                                                Titulo
                                                <input type="text" name="title"
                                                    value="<?= (isset($edit_title)) ? $edit_title : ''; ?>">
                                            </label>
                                    ...
                                    <?= (isset($edit_description)) ? $edit_description : '<p>Insira uma observação do seu pacote<p/>'; ?>
                                </textarea>
                                        </div>
                                        <div class="col s12" id="images">
                                            <div class="input">
                                                ...
                                                <input type="hidden" name="acomodacao"
                                                    value="<?= (isset($title)) ? $title : ''; ?>" />
                                                <input type="hidden" name="acomodacao_id"
                                                    value="<?= (isset($id)) ? $id : ''; ?>" />
                                            </div>
                                            <div class="start">
                                                <?php if(!empty($image)): ?>
                                    ...
                                    ?>
                                                <div class="col s12 m6 l3">
                                                    ...
                                                    <input type="file" id="<?= $item->getId(); ?>" name="image[]"
                                                        class="dropify" data-default-file="<?= $item->getImage(); ?>" />
    ...
    ?>
                        <tr>
                            ...
                            <td class="container__button">
                                <form method="POST" action="estrutura/delete"> <input type="hidden" name="_method"
                                ...
                                <div> <a href="ceara/edit/<?= $id ?>"> <button href="#"
                                            class="container__button-atualizar openModal-atualizar"><img
                                                class="container__button-atualizar-icon  atualizar-<?=$id?>"
                                                src="public/site/icons/pencil.svg" alt="Atualizar"></button></a> </div>
                            </td>
                        </tr>
                        <?php endforeach;?>

                    </table>
                    <a href="estrutura/create"> <button class="container__button-criar-icon"> Criar + 1</button>
                        </button>
                </div>
                <!--end container-->
            </section>
    ...
    <script>
        ...
        cntModal.onclick = function (event) {
