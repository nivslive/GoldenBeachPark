...
<head>
    ...
    <title> Criar Depoimento - ADMIN BeachParkHotel</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Criar Depoimento - Home</h2>
                        <form method="POST" action="depoimentos/persist" enctype="multipart/form-data">
                                ...
                                <label for="depoimento">
                                    Depoimento
                                    <input type="text" id="depoimento" name="depoimento"  required>
                                </label>
