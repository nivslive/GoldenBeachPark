...
<head>
    ...
    <title>Acomodação - ADMIN Golden Beach Hotel</title>
        ...
        <div class="wrapper">
            ...
            <div id="fade-atualizar">
                ...
                <div class="search container">
                    <h2>Busque Todas as Acomodações</h2>
                    <!--Static Data-->
                    <table>
    ...
    ?>
                        <tr>
                            ...
                            <td class="container__button">
                                <form method="POST" action="acomodacao/delete"> <input type="hidden" name="_method"
                                ...
                                <div> <a href="acomodacao/edit/<?=$id?>"><button  value="<?=$id?>" class="container__button-atualizar"><img
                                            class="container__button-atualizar-icon  atualizar-<?=$id?>"
                                            src="public/site/icons/pencil.svg"  alt="Atualizar"></button></a></div>               <div> <button href="#" value="<?=$id?>" class="container__button-itens openModal-itens"><img
            ...
            <a href="acomodacao/create"><button class="container__button-criar-icon"> Criar + 1</button></a>
...
for(let i = 0; i < open_itens.length; i++){
    open_itens[i].addEventListener("click", function(e) {
      ...
      console.log(URL+"acomodacao/itens/"+data);
      ...
      let xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL+"acomodacao/itens/"+data, true);
                                xhttp.send();
...
for(let i = 0; i < open.length; i++){
    open[i].addEventListener("click", function(e) {
      ...
      let xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL+"acomodacao/edit/"+data, true);
                                xhttp.send();
...
function editItens(id) {
    console.log(URL+"acomodacao/itens/edit/"+id);
    var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL+"acomodacao/itens/edit/"+id, true);
                                xhttp.send();
...
function createItens(id) {
    console.log(URL+"acomodacao/itens/create/"+id);
    var xhttp = new XMLHttpRequest();
                                xhttp.onreadystatechange = function() {
                                  if (this.readyState == 4 && this.status == 200) {
                                    document.getElementById("demo").innerHTML =
                                ...
                                xhttp.open("GET", URL+"acomodacao/itens/create/"+id, true);
                                xhttp.send();
