...
<head>
    ...
    <title>Serviços - ADMIN Golden Beach Hotels</title>
        ...
        <div class="wrapper">
            ...
            <div id="fade-atualizar">
                ...
                <div class="search container">
                    <h2>Busque Todos os Serviços</h2>
                    <!--Static Data-->
                    <table>
    ...
    ?>
                        <tr>
                            ...
                            <td class="container__button">
                                <form method="POST" action="servicos/delete"> <input type="hidden" name="_method"
...
for(let i = 0; i < open.length; i++){
    open[i].addEventListener("click", function(e) {
      ...
      var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"servicos/edit/"+data, true);
                                xhttp.send();
...
function create() {
    var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"servicos/create", true);
                                xhttp.send();
