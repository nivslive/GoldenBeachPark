                ...
                <div class="col s12" id="images">
                            ...
                            <div class="col s12 center">
                                    <div id="ItemList" class="card_list">
                                        ...
                                        <p>
                                        <button id="AddItem"  type="button" onclick="Test()">Adicionar Item</button>
                                        </p>
...
function Test() {
    ...
    <input type="hidden" name="acomodacao_item_id_value" value="${n}" />
    <section style="background-color: gray;padding: 2px;"> <span style="background: white; border-radius: 5px;"> Cadastro Container ${n} </span> 
    ...
    <label for="title">
                                    Titulo
                                    <input type="text" name="title_item_${n}" value="<?= (isset($acomodacao)) ? $acomodacao->getTitle() : ''; ?>">
                                </label>
                                <label for="description">
                                    Descrição completa
                                    <span class="fa fa-exclamation-circle"></span>
                                ...
                                <textarea name="description_item_${n}" class="editor" required>
                                    <?= (isset($acomodacao)) ? $acomodacao->getDescription() : '<p>Insira uma observação do seu item<p/>'; ?>
                                </textarea>
    </div>
