...
<head>
    ...
    <title> Criar Diferenciais - ADMIN BeachParkHotel</title>
        ...
        <div class="wrapper">
            ...
            <section class="row" id="content">
                ...
                <div class="cadastro container">
                    <fieldset>
                        <h2>Criar Diferenciais - Home</h2>
                        <form method="POST" action="diferenciais/persist" enctype="multipart/form-data">
                                ...
                                <div class="start">
                                    <?php if(!empty($image)): ?>
                                        ...
                                        <div class="col s12 m6 l3">
                                            ...
                                            <input type="file" id="<?= $id ?>" name="image[]" class="dropify" data-default-file="<?= $image ?>" />
