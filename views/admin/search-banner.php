...
<head>
    ...
    <title>Banners - ADMIN Golden Beach Hotel</title>
    ...
    ?>
                        <tr>
                            ...
                            <td class="container__button">
                                <form method="POST" action="banner/delete"> <input type="hidden" name="_method"
...
for(let i = 0; i < open.length; i++){
    open[i].addEventListener("click", function(e) {
      ...
      var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"banner/edit/"+data, true);
                                xhttp.send();
...
function create() {
    var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"banner/create", true);
                                xhttp.send();
