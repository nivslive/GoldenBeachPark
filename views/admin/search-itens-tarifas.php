...
<head>
    ...
    <title>Editar Itens Tarifas</title>
        ...
        <div class="wrapper">
            ...
            <div id="fade-atualizar">
                ...
                <div class="search container">
                    <h2>Itens Tarifa ID: <?=$global_id ?></h2>
                    <!--Static Data-->
                    <table>
    ...
    ?>
                        <tr>
                            ...
                            <td class="container__button">
                                <form method="POST" action="tarifas/itens/delete"> <input type="hidden" name="_method"
                                ...
                                <div> <button href="#" value="<?=$id?>" class="container__button-atualizar openModal-edit-itens" onclick="editItens(<?php echo $id ?>)"><img
