...
<head>
    ...
    <title>Todos os Depoimentos Cadastrados</title>
                ...
                <tr>
                        ...
                        <td><?=$depoimento?></td>
                            ...
                            <td class="container__button">
                                <form method="POST" action="depoimentos/delete"> <input type="hidden" name="_method"
...
for(let i = 0; i < open.length; i++){
    open[i].addEventListener("click", function(e) {
      ...
      let xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"depoimentos/edit/"+data, true);
                                xhttp.send();
...
function create() {
    var xhttp = new XMLHttpRequest();
                                ...
                                xhttp.open("GET", URL_BASE+"depoimentos/create", true);
                                xhttp.send();
